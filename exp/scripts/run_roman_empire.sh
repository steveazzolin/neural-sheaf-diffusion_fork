...
#SBATCH --job-name=nsd
#SBATCH -t 2-00:00
#SBATCH --output=/home/steve.azzolin/sheafs/neural-sheaf-diffusion_fork/sbatch_outputs/roman_empire.txt
#SBATCH --error=/home/steve.azzolin/sheafs/neural-sheaf-diffusion_fork/sbatch_outputs/roman_empire.txt
#SBATCH --ntasks=1
#SBATCH -N 1
